...
class TagName extends Model
{
    ...
    public static array $article=['طعام','عادات وتقاليد','السويداء','حماة','درعا','دير الزور','حلب','القنيطرة','طرطوس','اللاذقية','دمشق','حمص','ريف دمشق','ادلب','الحسكة','الرقة','ترفيهية','دينية','ثقافية','تاريخية','أثرية','طبيعية'];
    public static array $trip=['تاريخية','ثقافية','ترفيهية','دينية','طبيعية','أثرية','طعام','عادات وتقاليد'];
